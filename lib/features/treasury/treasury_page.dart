...
import 'package:flutter_starter/features/treasury/widgets/payroll_modal.dart';
...
class _TreasuryPageState extends State<TreasuryPage> {
                      ...
                      children: [
                        Expanded(
                          child: ElevatedButton.icon(
                            onPressed: () => _showPayrollModal(context),
  ...
  void _showPayrollModal(BuildContext context) {
    // Get mock employee data and convert to Employee objects
    final paymentData = [
      {'name': 'Sarah Johnson', 'amount': '\$12,500', 'date': 'Dec 15', 'status': 'Completed'},
      {'name': 'Mike Chen', 'amount': '\$10,800', 'date': 'Dec 15', 'status': 'Completed'},
      {'name': 'Emily Davis', 'amount': '\$9,200', 'date': 'Dec 15', 'status': 'Completed'},
    ...
    final employees = paymentData.map((data) => Employee.fromPaymentData(data)).toList();

    showDialog(
      context: context,
      builder: (context) => PayrollModal(employees: employees),
    );
  }
